...
def insert_vehicle_data():
    ...
    vehicle_data = [
    ("Toyota", "Camry", 2018, "Sedan", 35000, "Automatic", 4, "Operational", "Yes", "https://th.bing.com/th/id/R.ee3a8eb625b80e8a339ba413b6083356?rik=EqglPbjWgbUQWA&pid=ImgRaw&r=0", 1, "Fuel-efficient, Reliable, Spacious interior, Advanced safety, Smooth ride", 
    ...
    ("Ford", "F-150", 2020, "Truck", 25000, "Automatic", 4, "Operational", "Yes", "https://th.bing.com/th/id/OIP.qR61L25gB85KDDnqe0zYAQHaEo?rs=1&pid=ImgDetMain", 2, "Strong towing capacity, Spacious interior, Durable, High payload, Comfortable seats", 
    ...
    ("Chevrolet", "Tahoe", 2019, "SUV", 45000, "Automatic", 4, "In Repair", "No", "https://a4e5e0ff95b1cab202bf-6a8356f83a523ee2fe1677c35304c3f3.ssl.cf1.rackcdn.com/1GNSKCKC1KR265544/9e9f86b1524f6461a3ef78ce6de82f54.jpg", 3, "Spacious, Powerful engine, Family-friendly, High towing capacity, All-terrain capability", 
    ...
    ("Honda", "Accord", 2017, "Sedan", 50000, "Automatic", 4, "Operational", "Yes", "https://pictures.dealer.com/s/showcasehonda/0181/bf13f6d512d4f5ace1c36ea19ae4e7e6x.jpg", 1, "Reliable, High resale value, Comfortable, Advanced safety, Smooth handling", 
    ...
    ("Nissan", "Altima", 2016, "Sedan", 65000, "Automatic", 4, "In Repair", "No", "https://static0.topspeedimages.com/wordpress/wp-content/uploads/crop/201610/nissan-altima-driven-7_1600x0w.jpg", 2, "Comfortable, Efficient, Quiet ride, Affordable maintenance, Fuel-efficient", 
    ...
    ("Jeep", "Wrangler", 2015, "SUV", 75000, "Manual", 2, "Operational", "Yes", "https://hips.hearstapps.com/amv-prod-cad-assets.s3.amazonaws.com/wp-content/uploads/2015/02/2015-Jeep-Wrangler-Willys-202.jpg", 3, "Off-road capability, Iconic design, Rugged, Durable, Convertible option", 
    ...
    ("BMW", "3 Series", 2021, "Sedan", 15000, "Automatic", 4, "Operational", "Yes", "https://images.hgmsites.net/hug/2020-bmw-3-series-m340i-xdrive_100745229_h.jpg", 1, "Luxury interior, High performance, Advanced technology, Smooth handling, Stylish design", 
    ...
    ("Audi", "Q5", 2018, "SUV", 30000, "Automatic", 4, "In Repair", "No", "https://cdn.motor1.com/images/mgl/rlgVY/s1/2018-audi-q5-first-drive.jpg", 2, "Premium interior, Smooth handling, Quiet ride, All-wheel drive, Tech-savvy", 
    ...
    ("Tesla", "Model S", 2020, "Sedan", 20000, "Automatic", 4, "Operational", "Yes", "https://media.ed.edmunds-media.com/tesla/model-s/2019/oem/2019_tesla_model-s_sedan_performance_fq_oem_1_815.jpg", 3, "Electric, Advanced tech features, Long range, Fast acceleration, Futuristic design", 
    ...
    ("Ford", "Mustang", 2019, "Coupe", 22000, "Manual", 2, "Operational", "Yes", "https://media.carsandbids.com/cdn-cgi/image/width=1800,quality=70/ee7f173e46ec801a48d1673c50f9cebaa1bf2854/photos/307QRazV-A_eASqsRsp-(edit).jpg?t=167518885655", 1, "Sporty design, Powerful engine, Iconic styling, High performance, Customizable options", 
    ...
    ("Chevrolet", "Equinox", 2020, "SUV", 20000, "Automatic", 4, "Operational", "Yes", "https://images.cars.com/cldstatic/wp-content/uploads/chevrolet-equinox-2019-exterior-front-three-quarter-oem.jpg", 2, "Compact, Fuel-efficient, Smooth ride, Advanced safety, Affordable", 
    ...
    ("Toyota", "RAV4", 2017, "SUV", 60000, "Automatic", 4, "Operational", "Yes", "https://media.ed.edmunds-media.com/toyota/rav4/2017/oem/2017_toyota_rav4_4dr-suv_se_fq_oem_1_600.jpg", 3, "Reliable, Good resale value, Spacious interior, Off-road capable, Family-friendly", 
    ...
    ("Honda", "Civic", 2015, "Sedan", 90000, "Automatic", 4, "Operational", "Yes", "https://i.pinimg.com/736x/55/96/e6/5596e69dab32f19d87a3b025cdd8ada0.jpg", 1, "Fuel-efficient, Compact, Easy to park, Low maintenance, Reliable", 
    ...
    ("Nissan", "Sentra", 2018, "Sedan", 40000, "Automatic", 4, "Operational", "Yes", "https://vehicle-images.dealerinspire.com/75a0-110009814/3N1AB7AP0JY280015/99f1ae0d6551325e58d14476c524044a.jpg", 2, "Affordable, Reliable, Low maintenance, Compact, Comfortable ride", 
    ...
    ("Jeep", "Grand Cherokee", 2019, "SUV", 35000, "Automatic", 4, "In Repair", "No", "https://cdn.motor1.com/images/mgl/W02Jr/s1/2019-jeep-grand-cherokee-limited-x-review.webp", 3, "Off-road capable, Luxurious interior, Powerful engine, Spacious, Family-friendly", 
    ...
    ("BMW", "X5", 2021, "SUV", 18000, "Automatic", 4, "Operational", "Yes", "https://www.automotiveaddicts.com/wp-content/uploads/2021/07/2021-bmw-x5-xdrive45e.jpg", 1, "Luxurious, Powerful engine, High-tech, Comfortable, Versatile", 
    ...
    ("Audi", "A4", 2017, "Sedan", 55000, "Automatic", 4, "Operational", "Yes", "https://www.motortrend.com/uploads/sites/5/2017/07/2017-Audi-A4-20T-Quattro-front-three-quarter-e1500572290866.jpg", 2, "Premium features, Smooth handling, Stylish design, Advanced technology, Reliable", 
    ...
    ("Tesla", "Model 3", 2022, "Sedan", 10000, "Automatic", 4, "Operational", "Yes", "https://www.mclarencf.com/imagetag/258/4/l/Used-2022-Tesla-Model-3.jpg", 3, "Electric, Tech advanced, Long range, Futuristic design, Eco-friendly", 
    ...
    ("Ford", "Explorer", 2019, "SUV", 30000, "Automatic", 4, "In Repair", "No", "https://static.overfuel.com/photos/178/117877/image-1.webp", 1, "Spacious, Versatile, Comfortable, Family-friendly, All-terrain capable", 
    ...
    ("Chevrolet", "Malibu", 2016, "Sedan", 80000, "Automatic", 4, "In Repair", "No", "https://blog.consumerguide.com/wp-content/uploads/sites/2/2016/12/Screen-Shot-2016-12-21-at-2.47.29-PM-1024x640.png", 2, "Comfortable, Good fuel economy, Reliable, Spacious, Advanced safety", 
    ...
    ("Chevrolet", "Traverse", 2017, "SUV", 60000, "Automatic", 4, "Operational", "Yes", "https://media.ed.edmunds-media.com/chevrolet/traverse/2017/ot/2017_chevrolet_traverse_LIFE1_ot_207173_600.jpg", 2, "Spacious, Family-friendly, Cargo space, Reliable, Comfortable", 
    ...
    ("Toyota", "Corolla", 2015, "Sedan", 90000, "Automatic", 4, "Operational", "Yes", "https://images.ctfassets.net/c9t6u0qhbv9e/2015ToyotaCorollaTestDriveReviewsummary/dbf5731cc3b411907236abfb4024c13f/2015_Toyota_Corolla_Test_Drive_Review_summaryImage.jpeg", 3, "Reliable, Fuel-efficient, Compact, Low maintenance, Safe", 
    ...
    ("Tesla", "Cybertruck", 2023, "Truck", 20000, "Automatic", 4, "Operational", "Yes", "https://www.teslarati.com/wp-content/uploads/2023/07/tesla-cybertruck-texas-elon-musk-scaled-e1688899667930.jpeg", 3, "Electric, Futuristic design, High durability, All-terrain, Innovative", 
    ...
    ("Honda", "Pilot", 2021, "SUV", 15000, "Automatic", 4, "Operational", "Yes", "https://www.motortrend.com/uploads/sites/5/2020/06/2021-Honda-Pilot-Elite-2.jpg?w=768&width=768&q=75&format=webp", 1, "Spacious, Reliable, Comfortable, Family-oriented, Versatile", 
    ...
    ("Nissan", "Rogue", 2017, "SUV", 70000, "Automatic", 4, "In Repair", "No", "https://media.ed.edmunds-media.com/nissan/rogue/2017/oem/2017_nissan_rogue_4dr-suv_sv_fq_oem_1_1600.jpg", 2, "Compact, Fuel-efficient, Reliable, Affordable, Practical", 
    ...
    ("Jeep", "Compass", 2019, "SUV", 30000, "Automatic", 4, "Operational", "Yes", "https://drivingtorque.com/wp-content/uploads/2019/03/2019-jeep-compass-grey-front-side-review-roadtest.jpg", 3, "Off-road capable, Compact, Stylish, Reliable, Adventure-ready", 
    ...
    ("BMW", "5 Series", 2018, "Sedan", 40000, "Automatic", 4, "Operational", "Yes", "https://media.ed.edmunds-media.com/for-sale/8b-wbaja7c5xjwc75942/img-1-600x400.jpg", 1, "Luxury, High performance, Advanced safety, Spacious, Tech-savvy", 
    ...
    ("Audi", "Q7", 2020, "SUV", 25000, "Automatic", 4, "In Repair", "No", "https://images.ctfassets.net/c9t6u0qhbv9e/2020AudiQ7TestDriveReviewsummary/9f9d5d4a0d9e7c0618a8d74039b4a2b8/2020_Audi_Q7_Test_Drive_Review_summaryImage.jpeg", 2, "Luxurious, Spacious, Advanced safety, Family-friendly, Powerful engine", 
    ...
    ("Tesla", "Model X", 2019, "SUV", 20000, "Automatic", 4, "Operational", "Yes", "https://vehicle-images.dealerinspire.com/5466-110008891/5YJXCDE29KF180249/c717eb0a96b5afd22cd3822da7ca126d.jpg", 3, "Electric, High-tech features, Fast acceleration, Spacious, Safe", 
